...
#PENDIENTE FUNCION AGREGAR AMIGO
#PENDIENTE FUNCION MOSTRAR ESTADOS DE LOS AMIGOS
#mostrar amigos
...
def obtener_nombre():
    ...
    print("\n  tu nombre se utilizara como direccion para encontrarte en la base de datos")
    return nombre
...
def agregar_amigo(amigoN,listaA):
    listaA.append(amigoN)

def mostrar_muroAmigo(amigo):

    if existe_archivo(amigo+".user"):
        print("los mensajes del muro son: \n")
        archivo_usuario = open(amigo + ".user", "r")
        for i in range(6):
           archivo_usuario.readline()
        ...
        print("No hay mensajes o Ese nombre de usuario no existe")


mostrar_muroAmigo("juan")
